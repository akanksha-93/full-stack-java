 ...
 *
 *         Batch entity will have details for a particular batch. There will be
 *         2 type of batches like BelowBMI25 and AboveBMI25
 * 
 */
@Entity
public class Batch implements Serializable {
	...
	/*
	 * @OneToMany(targetEntity=Group11.class,mappedBy="batchId") private
	 * Set<Group11> groups;
	 */
	 ...
	 * Gets batch Id
	 * 
	 * @return String batch's unique ID
	 */
	 ...
	 * Sets batch Id.
	 * 
	 * @param batchId batch's unique ID
	 */
