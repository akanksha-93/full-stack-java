...
export class ViewUserLogsComponent implements OnInit {
  ...
  @ViewChild(MatTableDataSource) dataSourceDaily: MatTableDataSource<DailyLog> | null;
  @ViewChild(MatTableDataSource) dataSourceMonthly: MatTableDataSource<MonthlyMeasurement> | null;
